...
const ReviewCard: React.FC<{ review: Review }> = ({ review }) => {
    return (
        <div className="bg-white p-8 rounded-xl shadow-sm border transform hover:scale-105 transition-transform duration-300 flex flex-col h-full">
            <div className="flex items-center mb-4">
                <img src={review.avatarUrl} alt={review.author} className="w-14 h-14 rounded-full object-cover mr-4 border-2 border-brand-accent" />
                <div>
            ...
            <blockquote className="text-gray-600 italic relative flex-grow">
                <span className="absolute -top-3 -left-4 text-7xl text-slate-100 font-serif">“</span>
        ...
        <section className="bg-white py-16 md:py-20">
            <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 max-w-8xl">
                <div className="text-center mb-12">
                    ...
                    <div className="mt-4 w-24 h-1 bg-brand-accent mx-auto rounded"></div>
                </div>
