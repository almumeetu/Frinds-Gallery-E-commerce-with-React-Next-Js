...
import { wordpressOrderService, wordpressAuthService, wordpressCheckoutService, wordpressPageService } from './wordpressGraphQL';
...
export const getPage = async (uri: string) => {
  try {
    return await wordpressPageService.getPage(uri);
  } catch (error) {
...
export const getPaymentGateways = async () => {
  try {
    return await wordpressCheckoutService.getPaymentGateways();
  } catch (error) {
...
export const getShippingMethods = async () => {
  try {
    return await wordpressCheckoutService.getShippingMethods();
  } catch (error) {
